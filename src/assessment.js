...
//**none will access it and get undefined, but there are some that will try to access it and won't be able to find it: grandpa, dad, son.
...
/* Write a function called async.
  ...
  which changes the (**This needs to be worded as 'the value of the variable', instead**) variable foo (above) to 'bar'
...
function subway(personName) {
  function addIngredient(ingredient) {
    return ({ orderPerson: personName, ingredients: [ingredient]})
  }
